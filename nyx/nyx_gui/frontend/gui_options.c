...
{
	lv_obj_t *win = nyx_create_standard_window(SYMBOL_COPY" Nyx颜色主题", _action_win_nyx_colors_close);
	lv_win_add_btn(win, NULL, SYMBOL_SAVE" 保存与重载", _action_win_nyx_colors_save);
...
lv_res_t create_win_nyx_options(lv_obj_t *parrent_btn)
{
	...
	lv_label_set_static_text(label_txt2, "在Nyx中自定义#C7EA46 主题#和#C7EA46 强调色#。\n");
